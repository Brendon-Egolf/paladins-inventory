...
silent only
cd ~/git/paladins-inventory
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 app.js
badd +1 views/index.pug
badd +0 views/part-form.pug
badd +0 package.json
badd +216 ~/.vimrc
argglobal
silent! argdel *
...
exe 'vert 2resize ' . ((&columns * 101 + 133) / 267)
exe '3resize ' . ((&lines * 21 + 33) / 66)
exe 'vert 3resize ' . ((&columns * 133 + 133) / 267)
exe '4resize ' . ((&lines * 20 + 33) / 66)
exe 'vert 4resize ' . ((&columns * 133 + 133) / 267)
exe '5resize ' . ((&lines * 21 + 33) / 66)
exe 'vert 5resize ' . ((&columns * 133 + 133) / 267)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
